...
export default class CriarLista extends Component {
    ...
    render() {
        return (
            <div>
                <Menu paginaAnterior="/" titulo="Criar lista" logo={icone} />
                <form id="formNovaLista" onSubmit={this.salvar}>
                    <input onChange={this.aoAlterarNome} type="text" name="nome" value={this.state.nome} required placeholder="Digite o nome da lista" />
